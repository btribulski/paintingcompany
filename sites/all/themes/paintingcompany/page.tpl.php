...
<body class="<?php print $body_classes; ?>" id="body_image">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
		 <div id="homelink"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="/drupal/sites/all/themes/paintingcompany/images/clear.gif" alt="<?php print t('Home'); ?>" id="home-link" /></a></div>
