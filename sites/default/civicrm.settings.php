...
/*
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 THIS IS THE SETTINGS FILE FOR THE WEST-HOST VERSION *
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
 */
...
define( 'CIVICRM_UF_DSN'           , 'mysql://paintco_drupal:eagle5uck@localhost/paintco_drupal6?new_link=true' );
...
define( 'CIVICRM_DSN'          , 'mysql://paintco_drupal:eagle5uck@localhost/paintco_civicrm?new_link=true' );
...
$civicrm_root = '/var/www/paintingcompany/sites/all/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/paintingcompany/files/civicrm/templates_c/' );
...
define( 'CIVICRM_UF_BASEURL'      , 'http://paintincompany.localhost/' );
