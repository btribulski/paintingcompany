<?php /* Smarty version 2.6.26, created on 2014-01-14 09:46:48
         compiled from CRM/Activity/Form/Search/Common.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Activity/Form/Search/Common.tpl', 28, false),array('function', 'cycle', 'CRM/Activity/Form/Search/Common.tpl', 31, false),array('modifier', 'crmReplace', 'CRM/Activity/Form/Search/Common.tpl', 89, false),)), $this); ?>
<tr>
...
</label><br /><?php echo $this->_tpl_vars['form']['activity_survey_id']['html']; ?>

        <?php endif; ?>
        <?php if ($this->_tpl_vars['buildEngagementLevel']): ?>
            <br/ ><br />
            <label><?php echo $this->_tpl_vars['form']['activity_engagement_level']['label']; ?>
</label><br /><?php echo $this->_tpl_vars['form']['activity_engagement_level']['html']; ?>
...
'); document.getElementById('activity_contact_name').value = ''; return false;" ><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>clear<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>)</span><br />
   </td>
   <td colspan="2"><br />
	  <?php echo $this->_tpl_vars['form']['activity_contact_name']['html']; ?>
<br />
      <span class="description font-italic"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Complete OR partial Name of the Source Contact or the Assignee Contact.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span><br /><br />
