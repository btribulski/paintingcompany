<?php /* Smarty version 2.6.26, created on 2013-01-26 17:13:23
  ...
  <?php else: ?>
      ...
      <?php if ($this->_tpl_vars['element']['field_type'] == 'File'): ?>
          <?php if ($this->_tpl_vars['element']['field_value']['displayURL']): ?>
              <td class="crm-custom_data crm-displayURL"><a href="javascript:imagePopUp('<?php echo $this->_tpl_vars['element']['field_value']['imageURL']; ?>
