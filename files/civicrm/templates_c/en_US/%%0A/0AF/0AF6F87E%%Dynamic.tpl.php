<?php /* Smarty version 2.6.26, created on 2014-01-06 16:35:51
         compiled from CRM/Profile/Form/Dynamic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'CRM/Profile/Form/Dynamic.tpl', 37, false),array('modifier', 'substr', 'CRM/Profile/Form/Dynamic.tpl', 126, false),array('modifier', 'cat', 'CRM/Profile/Form/Dynamic.tpl', 127, false),array('block', 'ts', 'CRM/Profile/Form/Dynamic.tpl', 116, false),array('function', 'crmURL', 'CRM/Profile/Form/Dynamic.tpl', 259, false),)), $this); ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if (( $this->_tpl_vars['field']['data_type'] == 'Date' || ( ( ( $this->_tpl_vars['n'] == 'birth_date' ) || ( $this->_tpl_vars['n'] == 'deceased_date' ) || ( $this->_tpl_vars['n'] == 'activity_date_time' ) ) ) ) && $this->_tpl_vars['field']['is_view'] != 1): ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
