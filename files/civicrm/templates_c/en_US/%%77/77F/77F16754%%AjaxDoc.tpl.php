<?php /* Smarty version 2.6.26, created on 2013-01-27 11:33:35
         compiled from CRM/Core/AjaxDoc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'crmURL', 'CRM/Core/AjaxDoc.tpl', 23, false),array('function', 'crmAPI', 'CRM/Core/AjaxDoc.tpl', 190, false),)), $this); ?>
<html>
...
<script>
resourceBase = '<?php echo $this->_tpl_vars['config']->resourceBase; ?>
';
if (!jQuery) {  
...
restURL = '<?php echo CRM_Utils_System::crmURL(array('p' => "civicrm/ajax/rest"), $this);?>
';
...
<div id="selector"></div>
<div id="extra"></div>
<input size="90" maxsize=300 id="query" value="<?php echo CRM_Utils_System::crmURL(array('p' => "civicrm/ajax/rest",'q' => "json=1&debug=on&entity=Contact&action=get&sequential=1&return=display_name,email,phone"), $this);?>
"/>
